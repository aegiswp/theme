<?php
/**
 * SVG Element Reference Subject
 *
 * This file is used by the SVG-Sanitize library (enshrined/svg-sanitize) to represent element reference subjects for SVG sanitization.
 *
 * Purpose:
 * - Encapsulates logic for managing and tracking SVG element references and their usage.
 ...
 * - For custom subject changes, fork the library or use hooks/filters provided by the Aegis theme or WordPress.
 *
 * For developer documentation and onboarding. No logic or subject changes in this doc update.
 */

...
// Enforces strict type checking for all code in this file, ensuring type safety for backdrop blur block setting.
declare( strict_types=1 );

// Declares the namespace for the backdrop blur block setting.
namespace Aegis\Framework\BlockSettings;

// Imports classes, interfaces, and functions used by the backdrop blur block setting.
use Aegis\Dom\CSS;
use Aegis\Dom\DOM;

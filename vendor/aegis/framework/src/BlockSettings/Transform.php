...
// Enforces strict type checking for all code in this file, ensuring type safety for transform block setting.
declare( strict_types=1 );

// Declares the namespace for the transform block setting.
namespace Aegis\Framework\BlockSettings;

// Imports classes, interfaces, and functions used by the transform block setting.
use Aegis\Dom\DOM;

...
// Enforces strict type checking for all code in this file, ensuring type safety for paragraph block.
declare( strict_types=1 );

// Declares the namespace for the paragraph block.
namespace Aegis\Framework\CoreBlocks;

// Imports classes, interfaces, and functions used by the paragraph block.
use Aegis\Dom\CSS;
use Aegis\Dom\DOM;

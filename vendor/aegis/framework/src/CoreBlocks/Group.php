...
// Enforces strict type checking for all code in this file, ensuring type safety for group block.
declare( strict_types=1 );

// Declares the namespace for the group block.
namespace Aegis\Framework\CoreBlocks;

// Imports classes, interfaces, and functions used by the group block.
use Aegis\Dom\CSS;
use Aegis\Dom\DOM;

...
// Enforces strict type checking for all code in this file, ensuring type safety for social link block.
declare( strict_types=1 );

// Declares the namespace for the social link block.
namespace Aegis\Framework\CoreBlocks;

// Imports classes, interfaces, and functions used by the social link block.
use Aegis\Dom\CSS;
use Aegis\Dom\DOM;

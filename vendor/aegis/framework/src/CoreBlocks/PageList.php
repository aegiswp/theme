...
// Enforces strict type checking for all code in this file, ensuring type safety for page list block.
declare( strict_types=1 );

// Declares the namespace for the page list block.
namespace Aegis\Framework\CoreBlocks;

// Imports classes, interfaces, and functions used by the page list block.
use Aegis\Dom\CSS;
use Aegis\Dom\DOM;

...
return array(
	...
	<div class="wp-block-group is-style-aegis-border top has-secondary-background-color has-background" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--30)">
	...
	<p class="has-text-align-center has-small-font-size" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-right:var(--wp--preset--spacing--50);padding-bottom:0;padding-left:var(--wp--preset--spacing--50)">' . esc_html__( 'Introducing the Winter Fashion Promotion! Prepare to secure discounts on contemporary ensembles!', 'aegis' ) . '</p>
	<!-- /wp:paragraph -->	
	...
	<div class="wp-block-cover is-style-aegis-hover-shadow bottom" style="min-height:325px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span>
	<img class="wp-block-cover__image-background" alt="' . esc_attr__( 'Image', 'aegis' ) . '" src="' . esc_url( get_template_directory_uri() ) . '/assets/images/fashion-placeholder-7.jpg" data-object-fit="cover"/>
	...
	<!-- /wp:image -->
	<!-- wp:image {"sizeSlug":"large","linkDestination":"none","className":"is-style-aegis-shadow-image image-two"} -->
	<figure class="wp-block-image size-large is-style-aegis-shadow-image image-two"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/fashion-placeholder1.jpg" alt="' . esc_attr__( 'Image', 'aegis' ) . '"/></figure>
	<!-- /wp:image -->	
	...
	<p class="has-small-font-size" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0">' . esc_html__( 'Explore our curated categories to find the ideal look that suits you best.', 'aegis' ) . '</p>
	<!-- /wp:paragraph -->
	<!-- wp:separator {"backgroundColor":"septenary","className":"is-style-default"} -->
	<hr class="wp-block-separator has-text-color has-septenary-color has-alpha-channel-opacity has-septenary-background-color has-background is-style-default"/>
	<!-- /wp:separator -->
	...
	<!-- wp:woocommerce/featured-category {"editMode":false,"focalPoint":{"x":0.52,"y":0.26},"imageFit":"cover","mediaId":2012,"mediaSrc":"' . esc_url( get_template_directory_uri() ) . '/assets/images/fashion-placeholder-3.jpg","minHeight":566,"categoryId":19,"showDesc":false} -->
	<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
	<div class="wp-block-buttons">
	<!-- wp:button {"className":"is-style-aegis-button-shadow"} -->
	<div class="wp-block-button is-style-aegis-button-shadow"><a class="wp-block-button__link wp-element-button" href="">' . esc_html__( 'Urban Fashion', 'aegis' ) . '</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:buttons -->
	<!-- /wp:woocommerce/featured-category -->
	<!-- wp:woocommerce/featured-category {"editMode":false,"focalPoint":{"x":0.5,"y":0.67},"imageFit":"cover","mediaId":2009,"mediaSrc":"' . esc_url( get_template_directory_uri() ) . '/assets/images/fashion-placeholder-2.jpg","minHeight":358,"categoryId":22,"showDesc":false} -->
	<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
	<div class="wp-block-buttons">
	<!-- wp:button {"className":"is-style-aegis-button-shadow"} -->
	...
	<!-- wp:column -->
	<div class="wp-block-column">
	<!-- wp:woocommerce/featured-category {"editMode":false,"focalPoint":{"x":0.5,"y":0.52},"imageFit":"cover","mediaId":2010,"mediaSrc":"' . esc_url( get_template_directory_uri() ) . '/assets/images/fashion-placeholder-1.jpg","minHeight":424,"categoryId":17,"showDesc":false} -->
	<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
	<div class="wp-block-buttons">
	<!-- wp:button {"className":"is-style-aegis-button-shadow"} -->
	...
	<!-- wp:column -->
	<div class="wp-block-column">
	<!-- wp:woocommerce/featured-category {"editMode":false,"imageFit":"cover","mediaId":2011,"mediaSrc":"' . esc_url( get_template_directory_uri() ) . '/assets/images/fashion-placeholder-4.jpg","minHeight":422,"categoryId":20,"showDesc":false} -->
	<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
	<div class="wp-block-buttons">
	<!-- wp:button {"className":"is-style-aegis-button-shadow"} -->
	...
	<!-- /wp:columns -->
	<!-- wp:woocommerce/featured-category {"editMode":false,"focalPoint":{"x":0.43,"y":0.2},"imageFit":"cover","mediaId":2008,"mediaSrc":"' . esc_url( get_template_directory_uri() ) . '/assets/images/fashion-placeholder-5.jpg","minHeight":499,"categoryId":20,"showDesc":false,"textColor":"foreground"} -->
	<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
	<div class="wp-block-buttons">
	...
	<div class="wp-block-button is-style-aegis-button-shadow" style="font-style:normal;font-weight:600"><a class="wp-block-button__link has-foreground-background-color has-background wp-element-button" href="" style="border-radius:0px">' . esc_html__( 'Blouse', 'aegis' ) . '</a></div>
	<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
	<!-- /wp:woocommerce/featured-category -->

...
return array(
    ...
    'description' => __('Full-screen hero with cover background image, dark overlay, and light centered tagline, heading, paragraph, and social links', 'aegis'),
    'categories' => array('aegis-hero'),
    'content' => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"}}},"metadata":{"name":"' . esc_html__('04. Hero Pattern', 'aegis') . '"}} -->
    <div class="wp-block-group" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
        <!-- wp:cover {"url":"' . esc_url(get_template_directory_uri()) . '/assets/images/thumb_1920x1200_dark.webp","dimRatio":70,"overlayColor":"foreground","minHeight":100,"minHeightUnit":"vh","contentPosition":"center center","align":"full","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"},"margin":{"top":"0","bottom":"0"}}},"className":"is-style-default"} -->
            ...
            <div class="wp-block-cover__inner-container">
                ...
                <div class="wp-block-group" style="padding-top:0;padding-right:var(--wp--preset--spacing--30);padding-bottom:0;padding-left:var(--wp--preset--spacing--30)">
                    ...
                    <div class="wp-block-group" style="margin-top:0;margin-bottom:0">
                        ...
                        <p class="has-text-align-center is-tagline has-tiny-font-size" style="font-style:normal;font-weight:400;letter-spacing:3px;text-transform:uppercase">' . esc_html__('[tagline (60 characters): Provide a brief overview of a specific podcast topic, interview, or discussion.]', 'aegis') . '</p>
                        <!-- /wp:paragraph -->

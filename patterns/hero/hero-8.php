                ...
                <div class="wp-block-columns">
                    ...
                    <div class="wp-block-column" style="flex-basis:60%">
                        ...
                        <div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-right:var(--wp--preset--spacing--80)">
                            ...
                            <!-- wp:paragraph {"align":"left","style":{"typography":{"textTransform":"uppercase","letterSpacing":"3px","fontStyle":"normal","fontWeight":"400"},"color":{"background":"#1c1c1ee6"},"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"padding":{"right":"5px","left":"5px","top":"5px","bottom":"5px"}}},"textColor":"background","className":"has-tagline","fontSize":"tiny"} -->
                            <p class="has-text-align-left has-tagline has-background-color has-text-color has-background has-tiny-font-size" style="background-color:#1c1c1ee6;padding-top:5px;padding-right:5px;padding-bottom:5px;padding-left:5px;font-style:normal;font-weight:400;letter-spacing:3px;text-transform:uppercase">' . esc_html__('[tagline (60 characters): Provide a brief overview of a specific podcast topic, interview, or discussion.]', 'aegis') . '</p>
                            <!-- /wp:paragraph -->

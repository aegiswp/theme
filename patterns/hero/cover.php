...
<div class="wp-block-cover alignfull is-light"
	style="padding-top:var(--wp--preset--spacing--xxl);padding-right:0;padding-bottom:var(--wp--preset--spacing--xxl);padding-left:0;min-height:90vh">
	<span aria-hidden="true"
		class="wp-block-cover__background has-neutral-100-background-color has-background-dim-90 has-background-dim"></span>
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-group" style="margin-top:0;margin-bottom:0">
			...
			<h1 class="wp-block-heading has-text-align-center has-neutral-950-color has-text-color has-link-color has-60-font-size"
				style="line-height:1">Native Block Framework</h1>
			<!-- /wp:heading -->
			...
			<div class="wp-block-group">
				...
				<p
					class="aligncenter has-text-align-center has-neutral-600-color has-text-color has-link-color aligncenter">
			...
			<div class="wp-block-buttons"
				style="margin-top:var(--wp--preset--spacing--sm);margin-bottom:var(--wp--preset--spacing--sm)">
				...
				<div class="wp-block-button is-style-ghost"><a class="wp-block-button__link wp-element-button">Learn
						more</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->

...
<!-- wp:group {"metadata":{"categories":["header"],"patternName":"aegis/header-01","name":"<?php echo esc_html_x('01. Header Pattern', 'Name of the pattern', 'aegis'); ?>"},"align":"full","layout":{"inherit":false}} -->
		...
		<div class="wp-block-columns alignwide is-not-stacked-on-mobile" style="padding-right:0;padding-left:0">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:80%">
				...
				<div class="wp-block-group">
					<!-- wp:navigation {"ref":5,"icon":"menu","overlayBackgroundColor":"background","className":"is-style-default","layout":{"type":"flex","setCascadingProperties":"true","justifyContent":"right","orientation":"horizontal","flexWrap":"wrap"},"fontSize":"tiny"} /-->
				</div>
				<!-- /wp:group -->
			</div>
			<!-- /wp:column -->

    ...
    <div class="wp-block-cover alignwide" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50);min-height:100vh">
        ...
        <div class="wp-block-cover__inner-container">
            ...
            <div class="wp-block-group">
                ...
                <p class="has-text-align-left has-tiny-font-size" style="margin-bottom:-30px;font-style:normal;font-weight:400;letter-spacing:3px;text-transform:uppercase"><?php echo esc_html_x( 'Tagline', 'Enter a brief and descriptive tagline here.', 'aegis' ); ?></p>
                <!-- /wp:paragraph -->
                    ...
                    <div class="wp-block-column is-vertically-aligned-center" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;flex-basis:22%">
                        ...
                        <div class="wp-block-group">
                            ...
                            <div class="wp-block-group">
                                ...
                                <p class="has-text-align-left has-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:3px;line-height:1;text-transform:uppercase"><?php echo esc_html_x('Category', 'Replace with a descriptive category.', 'aegis'); ?>
                                </p>
                                <!-- /wp:paragraph -->

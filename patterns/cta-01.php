...
<div class="wp-block-group has-vertical-background-to-foreground-gradient-background has-background">
    <!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"padding":{"right":"var:preset|spacing|30","left":"var:preset|spacing|30","top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"gradient":"diagonal-tertiary-to-transparent-right-top"} -->
    <div class="wp-block-columns are-vertically-aligned-center has-diagonal-tertiary-to-transparent-right-top-gradient-background has-background"
        ...
        <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:60%">
            ...
            <p class="has-text-align-left has-tiny-font-size" style="margin-bottom:-15px;font-style:normal;font-weight:500;letter-spacing:3px;text-transform:uppercase">
                <?php echo esc_html_x( 'Limited Time Offer', 'CTA tagline (15-25 characters recommended)', 'aegis' ); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <h3 class="wp-block-heading has-gigantic-font-size" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;text-transform:uppercase">
                <?php echo esc_html_x( 'Take Action Today', 'CTA heading (15-30 characters recommended)', 'aegis' ); ?>
            </h3>
            <!-- /wp:heading -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%">
            ...
            <div class="wp-block-buttons">
                ...
                <div class="wp-block-button is-style-fill">
                    <a class="wp-block-button__link has-border-color has-background-border-color wp-element-button" style="border-width:2px" href="#"><?php echo esc_html_x( 'Sign Up Now', 'Primary action button text (10-20 characters recommended)', 'aegis' ); ?></a>
                </div>
                <!-- /wp:button -->
                ...
                <div class="wp-block-button is-style-fill">
                    <a class="wp-block-button__link has-foreground-color has-tertiary-background-color has-text-color has-background has-link-color wp-element-button" href="#">
                        <?php echo esc_html_x( 'Learn More', 'Secondary action button text (10-20 characters recommended)', 'aegis' ); ?> <span class="wp-element-button__arrow" aria-hidden="true">&rarr;</span>
                    </a>
                </div>
                <!-- /wp:button -->
            </div>

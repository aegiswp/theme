...
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x('09. Archive Pattern', 'Name of the pattern', 'aegis'); ?>","categories":["archives"],"patternName":"aegis/archive-09"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column is-style-hide-mobile" style="flex-basis:33.33%">
            ...
            <div class="wp-block-group is-style-section-dark has-diagonal-foreground-to-transparent-left-bottom-gradient-background has-background" style="padding-bottom:var(--wp--preset--spacing--40)">
            ...
            <div class="wp-block-group alignfull" style="padding-right:0">
                ...
                <div class="wp-block-group is-style-default" style="padding-right:0;padding-left:0">
                    ...
                    <div class="wp-block-query">
                        ...
                        <!-- wp:post-featured-image {"isLink":true,"aspectRatio":"16/9","dimRatio":100,"gradient":"diagonal-transparent-to-tiny-foreground-right-bottom","className":"is-style-default","style":{"color":{"duotone":"unset"},"border":{"radius":"4px"}}} /-->
                        ...
                        <div class="wp-block-group has-negative-margin" style="margin-top:-67px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
                            <!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"spacing":{"padding":{"top":"20px","right":"10px","bottom":"20px","left":"var:preset|spacing|30"}}},"backgroundColor":"foreground","textColor":"background","fontSize":"tiny"} -->
                            <p class="has-background-color has-foreground-background-color has-text-color has-background has-tiny-font-size" style="padding-top:20px;padding-right:10px;padding-bottom:20px;padding-left:var(--wp--preset--spacing--30);font-style:normal;font-weight:400"><?php echo esc_html_x( 'Date:', 'Post date label', 'aegis' ); ?></p>
                            <!-- /wp:paragraph -->
                            
                            <!-- wp:post-date {"className":"is-style-default","style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"spacing":{"padding":{"top":"20px","right":"var:preset|spacing|30","bottom":"20px","left":"10px"},"margin":{"top":"0","right":"0","bottom":"0","left":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|background"},":hover":{"color":{"text":"var:preset|color|quaternary"}}}}},"backgroundColor":"foreground","textColor":"background","fontSize":"tiny"} /-->

                            <!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"spacing":{"padding":{"top":"20px","right":"10px","bottom":"20px","left":"var:preset|spacing|30"}}},"backgroundColor":"foreground","textColor":"background","fontSize":"tiny"} -->
                            <p class="has-background-color has-foreground-background-color has-text-color has-background has-tiny-font-size" style="padding-top:20px;padding-right:10px;padding-bottom:20px;padding-left:var(--wp--preset--spacing--30);font-style:normal;font-weight:400"><?php echo esc_html_x( 'Categories:', 'Post categories label', 'aegis' ); ?></p>
                            <!-- /wp:paragraph -->
                            
                            <!-- wp:post-terms {"term":"category","className":"is-style-default","style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"spacing":{"padding":{"top":"20px","right":"var:preset|spacing|30","bottom":"20px","left":"10px"},"margin":{"top":"0","right":"0","bottom":"0","left":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|background"},":hover":{"color":{"text":"var:preset|color|quaternary"}}}}},"backgroundColor":"foreground","textColor":"background","fontSize":"tiny"} /-->
                        </div>
                        <!-- /wp:group -->
                        ...
                        <div class="wp-block-group is-style-section-dark has-foreground-background-color has-background" style="margin-bottom:var(--wp--preset--spacing--30);padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
                            <!-- wp:post-title {"level":3,"isLink":true,"className":"is-style-aegis-post-title-hide-underline is-style-hide-underline","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"},":hover":{"color":{"text":"var:preset|color|quaternary"}}}},"spacing":{"margin":{"bottom":"var:preset|spacing|30"}}},"textColor":"background","fontSize":"huge"} /-->

                            <!-- wp:post-excerpt {"moreText":"<?php echo esc_html_x( 'Read More', 'Post excerpt read more link text (15-25 characters recommended)', 'aegis' ); ?>","showMoreOnNewLine":false,"className":"is-style-default","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|30"}}}} /-->
                        </div>
                        <!-- /wp:group -->
                        <!-- /wp:post-template -->

...
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x('09. Archive Pattern', 'Name of the pattern', 'aegis'); ?>","categories":["archives"],"patternName":"aegis/archive-07"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"layout":{"type":"constrained"}} -->
            ...
            <div class="wp-block-group has-background-color has-foreground-background-color has-text-color has-background has-link-color">
                ...
                <div class="wp-block-group" style="padding-top:20px;padding-right:0;padding-bottom:0;padding-left:20px">
                    ...
                    <p class="has-text-align-left has-tiny-font-size" style="font-style:normal;font-weight:400;letter-spacing:3px;text-transform:uppercase">
                        <?php echo esc_html_x( 'Ad Space', 'Enter a brief and descriptive tagline here.', 'aegis' ); ?>
                    </p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            ...
            <div class="wp-block-group is-style-section-dark has-diagonal-foreground-to-transparent-left-bottom-gradient-background has-background" style="padding-bottom:var(--wp--preset--spacing--40)">
                ...
                <div class="wp-block-group" style="padding-top:0;padding-right:var(--wp--preset--spacing--40);padding-bottom:0;padding-left:var(--wp--preset--spacing--40)">
                    ...
                    <h3 class="wp-block-heading has-text-align-center has-large-font-size">
                        <?php echo esc_html_x( 'Product Name', 'Enter a brief and descriptive product title here.', 'aegis' ); ?>
                    </h3>
                    <!-- /wp:heading -->
            ...
            <div class="wp-block-group alignfull" style="padding-right:0">
                ...
                <div class="wp-block-group is-style-default" style="padding-right:0;padding-left:0">
                    ...
                    <div class="wp-block-query">
                        ...
                        <!-- wp:post-featured-image {"isLink":true,"aspectRatio":"16/9","dimRatio":100,"gradient":"diagonal-transparent-to-tiny-foreground-right-bottom","className":"is-style-default","style":{"color":{"duotone":"unset"}}} /-->
                        ...
                        <div class="wp-block-group has-negative-margin" style="margin-top:-67px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
                            <!-- wp:post-date {"className":"is-style-default","style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"spacing":{"padding":{"top":"20px","right":"var:preset|spacing|30","bottom":"20px","left":"var:preset|spacing|30"},"margin":{"top":"0","right":"0","bottom":"0","left":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|background"},":hover":{"color":{"text":"var:preset|color|quaternary"}}}}},"backgroundColor":"foreground","textColor":"background","fontSize":"tiny"} /-->

                            <!-- wp:post-terms {"term":"category","className":"is-style-default","style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"spacing":{"padding":{"top":"20px","right":"var:preset|spacing|30","bottom":"20px","left":"var:preset|spacing|30"},"margin":{"top":"0","right":"0","bottom":"0","left":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|background"},":hover":{"color":{"text":"var:preset|color|quaternary"}}}}},"backgroundColor":"foreground","textColor":"background","fontSize":"tiny"} /-->
                        </div>
                        <!-- /wp:group -->

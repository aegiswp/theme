...
<!-- wp:group {"metadata":{"name":"06. Archive Pattern","categories":["archives"],"patternName":"aegis/archive-06"},"layout":{"type":"constrained"}} -->
<div class="wp-block-group">
    ...
    <!-- wp:query {"queryId":14,"query":{"perPage":6,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[],"taxQuery":null},"align":"wide","layout":{"type":"default"}} -->
    <div class="wp-block-query alignwide">
        ...
        <div class="wp-block-group is-style-section-dark has-foreground-background-color has-background" style="margin-bottom:0;padding-right:0;padding-bottom:0">
            ...
            <div class="wp-block-cover"><span aria-hidden="true" class="wp-block-cover__background has-contrast-background-color has-background-dim-70 has-background-dim"></span>

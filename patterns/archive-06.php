...
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x('06. Archive Pattern', 'Name of the pattern', 'aegis'); ?>","categories":["archives"],"patternName":"aegis/archive-06"},"layout":{"type":"constrained"}} -->

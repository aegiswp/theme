...
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x('12. Blog Pattern', 'Name of the pattern', 'aegis'); ?>"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"gradient":"horizontal-foreground-to-background","layout":{"type":"constrained"}} -->

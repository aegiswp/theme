	...
	<img class="wp-block-cover__image-background" alt="Background Image" src="' . esc_url( get_template_directory_uri() ) . '/assets/images/placeholder_1800x1200_black.jpg" style="object-position:50% 50%" data-object-fit="cover" data-object-position="50% 50%" />
		<div class="wp-block-cover__inner-container">
			...
			<div class="wp-block-group">
				...
				<p class="has-tiny-font-size" style="margin-top:var(--wp--preset--spacing--30);margin-right:0;margin-bottom:0;margin-left:0;letter-spacing:10px;text-transform:uppercase">' . esc_html__( 'Content Title (11 chars)' , 'aegis' ). '</p>
				<!-- /wp:paragraph -->
				...
				<!-- wp:paragraph -->
				<p>' . esc_html__( 'Content Highlight (146 chars): [Promote an offer, summarize an article, or share a news update.]' , 'aegis' ). '</p>
				<!-- /wp:paragraph -->
				...
				<div class="wp-block-buttons">
					...
					<a class="wp-block-button__link wp-element-button" href="#" style="border-radius:0px">' . esc_html__( 'Call to Action' , 'aegis' ). '</a>
					</div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->

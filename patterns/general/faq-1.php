...
<div class="wp-block-group alignfull what-we-do gradient has-vertical-background-to-foreground-gradient-background has-background" style="padding-top:var(--wp--preset--spacing--60);padding-right:30px;padding-bottom:var(--wp--preset--spacing--60);padding-left:30px">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column" style="padding-right:var(--wp--preset--spacing--50);padding-left:0;flex-basis:56.66%">
			<!-- wp:heading {"level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"huge"} -->
			<h4 class="wp-block-heading has-huge-font-size" style="font-style:normal;font-weight:400">' . esc_html__( 'Heading Format (45 chars): [Present a ', 'aegis' ). ' <strong>' . esc_html__( 'welcoming tone' , 'aegis' ). '</strong> ' . esc_html__( 'for users	queries.]' , 'aegis' ). '</h4>
			<!-- /wp:heading -->
			...
			<div class="wp-block-group alignfull faq" style="padding-top:var(--wp--preset--spacing--30);padding-right:0px;padding-bottom:0px;padding-left:0px">
				...
				<div class="wp-block-group trigger is-style-default" style="border-bottom-color:var(--wp--preset--color--foreground);border-bottom-width:1px;padding-top:0;padding-right:0;padding-bottom:var(--wp--preset--spacing--30);padding-left:0">
					...
					<h4 class="wp-block-heading" style="font-style:normal;font-weight:400"><strong>' . esc_html__( '01.' , 'aegis' ). '</strong> ' . esc_html__( 'FAQ Question Format (57 chars): [Frame a frequently asked question about a feature or service.]' , 'aegis' ). '</h4>
					<!-- /wp:heading -->
			...
			<div class="wp-block-group alignfull faq" style="padding-top:var(--wp--preset--spacing--30);padding-right:0px;padding-bottom:0px;padding-left:0px">
				...
				<div class="wp-block-group trigger is-style-default" style="border-bottom-color:var(--wp--preset--color--foreground);border-bottom-width:1px;padding-top:0;padding-right:0;padding-bottom:var(--wp--preset--spacing--30);padding-left:0">
					<!-- wp:heading {"level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}}} -->
					<h4 class="wp-block-heading" style="font-style:normal;font-weight:400"><strong>' . esc_html__( '03.' , 'aegis' ). '</strong> ' . esc_html__( 'FAQ Question Format (57 chars): [Frame a frequently asked question about a feature or service.]' , 'aegis' ). '</h4>
					<!-- /wp:heading -->

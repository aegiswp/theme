...
<img class="wp-block-cover__image-background" alt="" src="' . esc_url( get_template_directory_uri() ) . '/assets/images/placeholder_1800x1200_black.jpg" style="object-position:50% 50%" data-object-fit="cover" data-object-position="50% 50%" />
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-group" style="padding-top:170px;padding-right:30px;padding-left:30px">
			...
			<h2 class="wp-block-heading has-text-align-center has-gigantic-font-size" style="font-style:normal;font-weight:400"><strong>' . esc_html__( '[Main' , 'aegis' ). '</strong> ' . esc_html__( 'Headline]' , 'aegis' ). '</h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center">' . esc_html__( 'Content Highlight (146 chars): [Promote an offer, summarize an article, or share a news update.]' , 'aegis' ). '</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button has-custom-font-size is-style-aegis-button-shadow has-small-font-size" style="font-style:normal;font-weight:600"><a class="wp-block-button__link wp-element-button" href="#" style="border-radius:0px">' . esc_html__( 'Call to Action' , 'aegis' ). '</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>

...
return array(
	...
	'description' => __( 'Header Hero', 'aegis' ),
	'categories' => array( 'aegis-header' ),
	'blockTypes' => array( 'core/template-part/header' ),
	'content' => '
<!-- wp:group {"align":"full","layout":{"type":"default"}} -->
<div class="wp-block-group alignfull">
	<!-- wp:cover {"url":"' . esc_url(get_template_directory_uri()) . '/assets/images/thumb_1800x1200_dark.webp","dimRatio":70,"overlayColor":"foreground","focalPoint":{"x":0.5,"y":0.5},"minHeight":800,"align":"full","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"className":"is-style-default header-hero additional"} -->
	<div class="wp-block-cover alignfull is-style-default header-hero additional" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;min-height:800px">
						...
						<div class="wp-block-columns alignwide">
							...
							<div class="wp-block-column">
								...
								<div class="wp-block-group alignwide has-search-and-icon">
									<!-- wp:search {"label":"Search","showLabel":false,"placeholder":"Search products…","width":350,"widthUnit":"px","buttonText":"Search","buttonPosition":"no-button","query":{"post_type":"product"},"style":{"border":{"width":"1px","color":"#1c1c1e"}},"className":"hide-on-mobile"} /-->

									<!-- wp:woocommerce/mini-cart {"miniCartIcon":"bag","addToCartBehaviour":"open_drawer","hasHiddenPrice":true,"iconColor":{"slug":"foreground","color":"#1c1c1e","name":"Foreground","class":"has-foreground-product-count-color"},"productCountColor":{"slug":"foreground","color":"#1c1c1e","name":"Foreground","class":"has-foreground-product-count-color"},"style":{"typography":{"fontSize":"12px"}}} /-->
								</div>
								<!-- /wp:group -->
							</div>
							<!-- /wp:column -->

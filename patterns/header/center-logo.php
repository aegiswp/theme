 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["header"],"patternName":"center-logo","name":"Center Logo"},"align":"full","className":"is-style-default","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"right":"var:preset|spacing|xs","left":"var:preset|spacing|xs"}},"position":{"all":""},"overflow":{"all":"visible"},"display":{"mobile":""},"top":{"all":""},"right":{"all":""},"bottom":{"all":""},"left":{"all":""},"zIndex":{"all":"99"},"width":{"all":"100%"}},"layout":{"type":"constrained","orientation":"horizontal"}} -->
<div class="wp-block-group alignfull is-style-default"
	...
	<!-- wp:group {"align":"wide","className":"is-style-default","style":{"spacing":{"padding":{"top":"4px","bottom":"4px"}},"position":{"all":"relative"}},"layout":{"type":"default"}} -->
	<div class="wp-block-group alignwide is-style-default" style="padding-top:4px;padding-bottom:4px">
		<!-- wp:columns {"verticalAlignment":"center","isStackedOnMobile":false,"align":"wide","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|xs"}},"position":{"all":"relative"},"zIndex":{"all":"1"}}} -->
		<div class="wp-block-columns alignwide are-vertically-aligned-center is-not-stacked-on-mobile"
			style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--xs)">
			<!-- wp:column {"verticalAlignment":"center","width":"50%"} -->
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
				<!-- wp:social-links {"iconColor":"inherit","iconColorValue":"inherit","size":"has-small-icon-size","className":"is-style-logos-only","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|xs"}}},"layout":{"type":"flex","justifyContent":"left","orientation":"horizontal"}} -->
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:33%">
				<!-- wp:group {"style":{"spacing":{"blockGap":"4px"},"zIndex":{"all":"0"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"},"onclick":""} -->
				<div class="wp-block-group">
					<!-- wp:image {"className":"is-style-icon","iconSet":"social","iconName":"aegis","iconSize":"50px","iconSvgString":"\u003csvg xmlns=\u0022http://www.w3.org/2000/svg\u0022 viewBox=\u00220 0 24 24\u0022 fill=\u0022currentColor\u0022 role=\u0022img\u0022 aria-labelledby=\u0022icon-696a106ee5d63\u0022 data-icon=\u0022social-aegis\u0022 width=\u002224\u0022 height=\u002224\u0022\u003e\u003ctitle id=\u0022icon-696a106ee5d63\u0022\u003eAegis Icon\u003c/title\u003e\u003cpath fill-rule=\u0022evenodd\u0022 d=\u0022M10.06 7.75 L12.02 3.87 L13.95 7.72 L16.65 9.29 L12.03 0 L7.34 9.3 L10.06 7.75 Z M18.37 12.72 L18.2 12.36 L15.5 10.79 L17.02 13.68 L20.05 18.61 L12.02 15.17 L3.98 18.62 L6.96 13.68 L8.39 10.81 L5.67 12.39 L5.5 12.71 L0 22.87 L12.01 16.87 L24 22.94 L18.37 12.72 Z\u0022\u003e\u003c/path\u003e\u003c/svg\u003e"} -->
					<figure class="wp-block-image is-style-icon"
						style="--wp--custom--icon--size:50px;--wp--custom--icon--url:url('data:image/svg+xml;utf8,<svg xmlns=&quot;http://www.w3.org/2000/svg&quot; viewBox=&quot;0 0 24 24&quot; fill=&quot;currentColor&quot; role=&quot;img&quot; aria-labelledby=&quot;icon-696a106ee5d63&quot; data-icon=&quot;social-aegis&quot; width=&quot;24&quot; height=&quot;24&quot;&gt;<title id=&quot;icon-696a106ee5d63&quot;&gt;Aegis Icon</title&gt;<path fill-rule=&quot;evenodd&quot; d=&quot;M10.06 7.75 L12.02 3.87 L13.95 7.72 L16.65 9.29 L12.03 0 L7.34 9.3 L10.06 7.75 Z M18.37 12.72 L18.2 12.36 L15.5 10.79 L17.02 13.68 L20.05 18.61 L12.02 15.17 L3.98 18.62 L6.96 13.68 L8.39 10.81 L5.67 12.39 L5.5 12.71 L0 22.87 L12.01 16.87 L24 22.94 L18.37 12.72 Z&quot;&gt;</path&gt;</svg&gt;')">
						<img alt="" />
					</figure>
					<!-- /wp:image -->
				</div>
			...
			<!-- wp:column {"verticalAlignment":"center","width":"50%"} -->
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
				<!-- wp:group {"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|xs"}},"\u002d\u002dflex-direction":"row-reverse","\u002d\u002dflex-direction-desktop":"row"},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"right"}} -->
				<div class="wp-block-group">
					...
					<div class="wp-block-buttons" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0">
						...
						<div class="wp-block-button search-close has-box-shadow"
							...
							<a class="wp-block-button__link has-current-color has-transparent-background-color has-text-color has-background has-14-font-size has-custom-font-size wp-element-button"
								style="padding-top:6px;padding-right:6px;padding-bottom:6px;padding-left:6px"></a>
						</div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
					...
					<div class="wp-block-group alignfull search-modal"
						role="dialog" aria-modal="true" aria-label="<?php esc_attr_e( 'Search', 'aegis' ); ?>" aria-hidden="true"
					...
					<div class="wp-block-buttons">
						...
						<div class="wp-block-button search-toggle has-box-shadow"
							...
							<a class="wp-block-button__link has-inherit-color has-transparent-background-color has-text-color has-background has-link-color has-14-font-size has-custom-font-size wp-element-button"
								style="padding-top:4px;padding-right:4px;padding-bottom:4px;padding-left:4px"></a>
						</div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
					...
					<div class="wp-block-buttons">
						...
						<div class="wp-block-button is-hide-mobile nowrap is-style-ghost"><a
								class="wp-block-button__link wp-element-button" style="line-height:2"><?php echo esc_html__( 'Subscribe', 'aegis' ); ?></a>
						</div>
						<!-- /wp:button -->
						...
						<div class="wp-block-button is-hide-mobile nowrap is-style-ghost"
							...
							<a class="wp-block-button__link wp-element-button"
								href="#" style="line-height:2"><?php echo esc_html__( 'Log In', 'aegis' ); ?></a>
						</div>
						<!-- /wp:button -->
						...
						<div class="wp-block-button is-hide-mobile nowrap is-style-fill"
							...
							<a class="wp-block-button__link wp-element-button"
								href="#"
								style="line-height:2"><?php echo esc_html__( 'Sign Up', 'aegis' ); ?></a>
						</div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
	...
	<!-- wp:group {"align":"full","className":"is-style-default","style":{"spacing":{"padding":{"top":"var:preset|spacing|xxs","bottom":"var:preset|spacing|xxs"}}},"layout":{"type":"constrained"}} -->
	<div class="wp-block-group alignfull is-style-default"
		style="padding-top:var(--wp--preset--spacing--xxs);padding-bottom:var(--wp--preset--spacing--xxs)">
		<!-- wp:group {"metadata":{"name":""},"align":"full","className":"is-style-default","style":{"position":{"all":"relative"}},"layout":{"type":"constrained"}} -->
		<div class="wp-block-group alignfull is-style-default">
			<!-- wp:group {"style":{"gridColumnStart":{"all":"3","mobile":"12"},"gridColumnEnd":{"all":"11","mobile":"13"},"gridRowStart":{"all":"1"},"gridRowEnd":{"all":"2"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
			<div class="wp-block-group">
				<!-- wp:navigation {"icon":"menu","metadata":{"ignoredHookedBlocks":["woocommerce/customer-account"]},"style":{"spacing":{"padding":{"top":"var:preset|spacing|xxs","bottom":"var:preset|spacing|xxs"}}},"layout":{"type":"flex","justifyContent":"space-between"}} /-->
			</div>
			<!-- /wp:group -->
		</div>
		<!-- /wp:group -->

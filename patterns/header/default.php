			...
			<div class="wp-block-group">
				...
				<div class="wp-block-buttons">
					...
					<div class="wp-block-button is-hide-mobile nowrap is-style-ghost"><a
							class="wp-block-button__link wp-element-button" style="line-height:2"><?php echo esc_html__( 'Subscribe', 'aegis' ); ?></a></div>
					<!-- /wp:button -->
					...
					<div class="wp-block-button is-hide-mobile nowrap is-style-ghost"
						...
						<a class="wp-block-button__link wp-element-button"
							href="https://www.atmostfear-entertainment.com/contact/" style="line-height:2"><?php echo esc_html__( 'Log In', 'aegis' ); ?></a>
					</div>
					<!-- /wp:button -->
					...
					<div class="wp-block-button is-hide-mobile nowrap is-style-fill"
						...
						<a class="wp-block-button__link wp-element-button"
							href="#" style="line-height:2"><?php echo esc_html__( 'Sign Up', 'aegis' ); ?></a>
					</div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->

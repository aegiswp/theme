...
return array(
    ...
    'description' => __('04. Header (Sticky)', 'aegis'),
    'categories'  => array('aegis-header'),
    'blockTypes'  => array('core/template-part/header'),
    'content'     => '
	<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"className":"header header-4","layout":{"inherit":false}} -->
	<div class="wp-block-group alignfull header header-4" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
		<!-- wp:group {"style":{"spacing":{"padding":{"top":"10px","right":"var:preset|spacing|30","bottom":"10px","left":"var:preset|spacing|30"}}},"backgroundColor":"secondary","className":"header-banner","layout":{"type":"constrained"}} -->
		...
		<!-- wp:group {"style":{"spacing":{"padding":{"top":"10px","right":"var:preset|spacing|30","left":"var:preset|spacing|30","bottom":"10px"},"margin":{"top":"0","bottom":"0"}}},"className":"header-socials","layout":{"type":"constrained"}} -->

				...
				<div class="wp-block-group is-style-aegis-border has-background-background-color has-background" style="padding-top:10%;padding-right:10%;padding-bottom:10%;padding-left:10%">
					...
					<div class="wp-block-columns">
						...
						<div class="wp-block-column" style="flex-basis:100%">
							...
							<p class="has-foreground-color has-text-color has-small-font-size">' . esc_html__( 'Testimonials that are too long can overwhelm visitors, especially in a grid format. Around 155 characters are usually enough to convey a message.', 'aegis' ) . '</p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:column -->
					</div>
					...
					<div class="wp-block-group">
						...
						<figure class="wp-block-image size-full is-resized is-style-rounded"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/placeholder_80x80_darkcolor.webp" alt="' . esc_attr__( 'Describe the main elements of the image and its context.', 'aegis' ) . '" /></figure>
						<!-- /wp:image -->

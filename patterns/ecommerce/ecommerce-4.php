...
return array(
	...
	<div class="wp-block-group alignwide has-diagonal-background-to-secondary-gradient-background has-background"
		style="padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px">
		<!-- wp:group {"style":{"border":{"width":"2px"},"spacing":{"padding":{"top":"30px","right":"30px","bottom":"30px","left":"30px"}}},"borderColor":"foreground","gradient":"diagonal-secondary-to-background"} -->
		<div class="wp-block-group has-border-color has-foreground-border-color has-diagonal-secondary-to-background-gradient-background has-background"

...
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x('04. Archive Pattern', 'Name of the pattern', 'aegis'); ?>","categories":["archives"],"patternName":"aegis/archive-04"},"layout":{"type":"constrained"}} -->

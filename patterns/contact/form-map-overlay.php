 ...
 * Categories: contact
 * Keywords: contact, form, map, overlay
 * Description: A contact form with map overlay background.
 * Viewport Width: 1280
 */
?>
...
<div class="wp-block-group alignfull has-neutral-50-background-color has-background" style="margin-top:0;margin-bottom:0;padding-bottom:var(--wp--preset--spacing--xl)"><!-- wp:aegis/map {"provider":"openstreetmap"} /-->
    ...
    <div class="wp-block-group alignfull" style="margin-top:-300px;padding-bottom:var(--wp--preset--spacing--lg)"><!-- wp:group {"className":"is-style-surface","style":{"spacing":{"padding":{"top":"var:preset|spacing|lg","right":"var:preset|spacing|lg","bottom":"var:preset|spacing|lg","left":"var:preset|spacing|lg"},"margin":{"top":"0","bottom":"0"}},"width":{"all":"100%"}},"backgroundColor":"neutral-0","layout":{"type":"default"},"shadowPreset":"xxl"} -->
        <div class="wp-block-group is-style-surface has-neutral-0-background-color has-background  has-shadow has-xxl-shadow" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--lg)"><!-- wp:paragraph {"align":"center","className":"is-style-sub-heading"} -->
            ...
            <h2 class="wp-block-heading has-text-align-center" style="margin-top:var(--wp--preset--spacing--xxs);margin-bottom:var(--wp--preset--spacing--sm)"><?php echo esc_html__( 'Contact Us', 'aegis' ); ?></h2>
            <!-- /wp:heading -->

<?php
/**
 * Title: Contact Form Featured Image Overlay
 * Slug: form-featured-image-overlay
 * Categories: contact
 * Keywords: contact, form, featured image, overlay
 * Description: A contact form with featured image overlay background.
 * Viewport Width: 1280
 */
?>

<!-- wp:group {"metadata":{"categories":["contact"],"patternName":"form-featured-image-overlay","name":"Contact Form Featured Image Overlay"},"align":"full","style":{"spacing":{"blockGap":"0","padding":{"bottom":"var:preset|spacing|xl"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"neutral-50","layout":{"type":"default"}} -->
<div class="wp-block-group alignfull has-neutral-50-background-color has-background" style="margin-top:0;margin-bottom:0;padding-bottom:var(--wp--preset--spacing--xl)">
    <!-- wp:post-featured-image {"align":"wide","style":{"aspectRatio":{"all":"16/9"},"objectFit":{"all":"cover"},"color":[],"order":{"mobile":""},"position":{"all":"relative"}},"usePlaceholder":"none"} /-->
    ...
    <div class="wp-block-group alignfull" style="margin-top:-300px;padding-bottom:var(--wp--preset--spacing--lg)">
        ...
        <div class="wp-block-group is-style-surface has-neutral-0-background-color has-background  has-shadow has-xxl-shadow" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--lg)">
            ...
            <form action="#" method="POST">
                ...
                <div class="wp-block-buttons is-layout-flex">
                    <div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button">Send</a></div>
                </div>
            </form>
            <!-- /wp:html -->
        </div>

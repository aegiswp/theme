 ...
 * Slug: aegis/event-03
 * Categories: events
 * Description: Multicolumn with tagline, heading, paragraph on the left and vertical gallery showcase on the right
 * Keywords: events
 * Viewport Width: 1400
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column is-vertically-aligned-top">
            ...
            <div class="wp-block-group" style="padding-top:0;padding-bottom:0">
                ...
                <h2 class="wp-block-heading" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px;padding-top:0;padding-bottom:0;font-size:5.8rem;text-transform:uppercase"><?php echo esc_html_x('[Heading]', 'Replace with a descriptive section title.', 'aegis'); ?></h2>
                <!-- /wp:heading -->

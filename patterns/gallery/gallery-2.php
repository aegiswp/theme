...
return array(
    ...
    'content' => '<!-- wp:group {"metadata":{"name":"' . esc_html__('02. Gallery Pattern', 'aegis') . '"},"style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"backgroundColor":"foreground","textColor":"background","layout":{"type":"default"}} -->

...
<!-- wp:group {"metadata":{"categories":["blog"],"patternName":"featured-post","name":"Featured Post"},"align":"wide","className":"is-style-surface","style":{"spacing":{"padding":{"top":"var:preset|spacing|md","bottom":"var:preset|spacing|md","left":"var:preset|spacing|md","right":"var:preset|spacing|md"}}}} -->
            ...
            <div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center","width":""} -->
                ...
                <div class="wp-block-column is-vertically-aligned-center">
                    ...
                    <div class="wp-block-group alignwide">
                        ...
                        <h2 class="wp-block-heading has-text-align-left has-52-font-size"
                            style="font-style:normal;font-weight:500;text-decoration:none"><a
                                href="https://www.atmostfear-entertainment.com/chronicles/andean/" data-type="category"
                                data-id="105052">Featured Post</a></h2>
                        <!-- /wp:heading -->
                    </div>
                    <!-- /wp:group -->

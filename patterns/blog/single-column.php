...
<!-- wp:group {"metadata":{"categories":["blog"],"patternName":"single-column","name":"Single Column"},"align":"full","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull">
    <!-- wp:heading {"textAlign":"center","level":1,"style":{"spacing":{"margin":{"top":"var:preset|spacing|lg"}}}} -->
    <h1 class="wp-block-heading has-text-align-center" style="margin-top:var(--wp--preset--spacing--lg)">Latest Posts
    </h1>
    <!-- /wp:heading -->
    ...
    <div style="padding-top:var(--wp--preset--spacing--sm);padding-bottom:var(--wp--preset--spacing--lg)"
        class="wp-block-query"><!-- wp:post-template {"layout":{"type":"default"}} -->

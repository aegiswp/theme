 ...
 * Description: Marketing pattern with heading, paragraph, image, and call to action button
    ...
    <div class="wp-block-group has-border-color has-foreground-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
        ...
        <div class="wp-block-columns">
            ...
            <div class="wp-block-column is-vertically-aligned-center">
                ...
                <h4 class="wp-block-heading has-text-align-center has-gigantic-font-size" style="margin-top:var(--wp--preset--spacing--30);letter-spacing:10px;text-transform:uppercase"><?php echo esc_html_x('[Heading]', 'Replace with a descriptive title', 'aegis'); ?></h4>
                <!-- /wp:heading -->
                ...
                <p class="has-text-align-center has-small-font-size" style="margin-top:0">
                    <em><?php echo esc_html_x('[Description (38 characters): Enter a brief limited time offer and prompt action.]', 'Call to action section text', 'aegis'); ?></em>
                </p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:column -->
            ...
            <div class="wp-block-column">
                ...
                <figure class="wp-block-image is-resized aligncenter size-full is-style-rounded">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/thumb_800x800_dark.webp" alt="<?php echo esc_attr__('Placeholder image: Brief description of the image and its context, non-text content for screen readers.', 'aegis'); ?>" style="aspect-ratio:1;object-fit:cover;width:150px" />
                </figure>
                <!-- /wp:image -->
                ...
                <!-- wp:paragraph {"align":"center"} -->
                <p class="has-text-align-center"><?php echo esc_html_x('[Description (75 characters): Enter a brief overview of a discount, promotion, or overview on specific items or collections.]', 'Call to action section text', 'aegis'); ?></p>
                <!-- /wp:paragraph -->

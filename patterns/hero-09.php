 ...
 * Slug: aegis/hero-09
 * Categories: hero
 * Description: Block pattern featuring a parallax cover with a diagonal gradient background, vertical social media links, and a tagline alongside a left-aligned headline and call-to-action button. Designed for striking visual impact and accessibility.
 * Keywords: hero, cover, parallax, social links, headline, tagline, call-to-action
 * Viewport Width: 1400
 * Block Types: core/button, core/buttons, core/cover, core/columns, core/group, core/heading, core/paragraph, core/social-link, core/social-links
 * Inserter: true
 *
 * @package aegis
 * @since 1.0.0
...
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x('09. Hero Pattern', 'Name of the pattern', 'aegis'); ?>","categories":["<?php echo esc_html_x('hero', 'Name of the category', 'aegis'); ?>"],"patternName":"aegis/hero-09"},"align":"full"} -->
<div class="wp-block-group alignfull">
	<!-- wp:cover {"url":"<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/thumb_1920x1200_dark.webp","alt":"<?php echo esc_attr__( 'Abstract illustration featuring the theme\'s logo. Please replace this image with your own.', 'aegis' ); ?>","hasParallax":true,"dimRatio":60,"isUserOverlayColor":true,"minHeight":100,"minHeightUnit":"vh","gradient":"diagonal-transparent-to-large-foreground-left-bottom","contentPosition":"center center","align":"full","className":"is-style-container-stretch","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"margin":{"top":"0","bottom":"0"}},"color":{"duotone":"unset"}}} -->

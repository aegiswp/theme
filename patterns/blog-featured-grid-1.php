<?php
/**
 * Title: 01. Blog Featured Grid Pattern
 * Slug: aegis/blog-featured-grid-1
 * Categories: blog
...
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x('01. Blog Featured Grid Pattern', 'Name of the pattern', 'aegis'); ?>"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"gradient":"diagonal-secondary-to-background","layout":{"type":"constrained"}} -->

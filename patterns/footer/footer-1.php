...
return array(
	...
	<figure class="wp-block-image size-full"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/icon-1.jpg" alt="' . esc_attr__( 'Icon represeting a delivery truck', 'aegis' ) . '" /></figure>
	<!-- /wp:image --></div>
	<!-- /wp:column -->	
	<!-- wp:column {"width":"90%"} -->
	...
	<p class="has-small-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--30)"><a href="#">' . esc_html__( 'See Our Stores', 'aegis' ) . '</a></p>
	<!-- /wp:paragraph -->	

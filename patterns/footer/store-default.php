	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column" style="flex-basis:16.66%">
			...
			<ul style="list-style-type:none" class="is-style-none has-14-font-size">
				...
				<!-- /wp:list-item -->
				<!-- wp:list-item -->
				<li><a href="#"><?php echo esc_html__( 'On Sale', 'aegis' ); ?></a></li>
				<!-- /wp:list-item -->
				<!-- wp:list-item -->
				<li><a href="#"><?php echo esc_html__( 'Featured', 'aegis' ); ?></a></li>
				<!-- /wp:list-item -->
				<!-- wp:list-item -->
				<li><a href="#"><?php echo esc_html__( 'New Arrivals', 'aegis' ); ?></a></li>
				<!-- /wp:list-item -->
			</ul>
			<!-- /wp:list -->
		</div>
		...
		<div class="wp-block-column" style="flex-basis:16.66%">
			...
			<ul style="list-style-type:none" class="is-style-none has-14-font-size">
				...
				<!-- /wp:list-item -->
				<!-- wp:list-item -->
				<li><a href="<?php echo esc_url( aegis_url( '/shipping-returns/' ) ); ?>"><?php echo esc_html__( 'Shipping & Returns', 'aegis' ); ?></a></li>
				<!-- /wp:list-item -->
				<!-- wp:list-item -->
				<li><a href="<?php echo esc_url( aegis_url( '/faq/' ) ); ?>"><?php echo esc_html__( 'FAQ', 'aegis' ); ?></a></li>
				<!-- /wp:list-item -->
				<!-- wp:list-item -->
				<li><a href="<?php echo esc_url( aegis_wc_page_url( 'myaccount' ) ); ?>"><?php echo esc_html__( 'My Account', 'aegis' ); ?></a></li>
				<!-- /wp:list-item -->
			</ul>
			<!-- /wp:list -->
		</div>

...
<!-- wp:group {"metadata":{"categories":["hidden"],"patternName":"minimal","name":"404 Minimal"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|xl","bottom":"var:preset|spacing|xl"}},"dimensions":{"minHeight":"60vh"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center","verticalAlignment":"center"}} -->
<div class="wp-block-group alignfull" style="min-height:60vh;padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl)">
	...
	<h1 class="wp-block-heading has-text-align-center has-36-font-size"><?php echo esc_html__( 'Page Not Found', 'aegis' ); ?></h1>
	<!-- /wp:heading -->
	...
	<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--sm)">
		...
		<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-neutral-800-background-color has-background has-15-font-size has-custom-font-size wp-element-button" href="/"><?php echo esc_html__( 'Back to Homepage', 'aegis' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>

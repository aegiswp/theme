...
<div class="wp-block-group alignfull has-neutral-50-background-color has-background" style="min-height:70vh;padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl)">
	...
	<figure class="wp-block-image aligncenter size-full is-resized"><img alt="" style="height:auto;width:280px" /></figure>
	<!-- /wp:image -->

	<!-- wp:heading {"textAlign":"center","level":1,"fontSize":"40","style":{"spacing":{"margin":{"top":"var:preset|spacing|md"}}}} -->
	<h1 class="wp-block-heading has-text-align-center has-40-font-size" style="margin-top:var(--wp--preset--spacing--md)"><?php echo esc_html__( 'Oops! Nothing Here', 'aegis' ); ?></h1>
	<!-- /wp:heading -->

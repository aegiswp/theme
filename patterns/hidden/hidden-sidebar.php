...
<div class="wp-block-group" style="padding-right:0;padding-left:0">
	...
	<div class="wp-block-group" style="margin-top:0;margin-bottom:0">
		...
		<div class="wp-block-group">
			...
			<h2 class="wp-block-heading" style="font-size:1.6rem"><?php esc_html_e( 'About the author', 'aegis' ); ?></h2>
			<!-- /wp:heading -->
	...
	<div class="wp-block-group">
		<!-- wp:heading {"style":{"typography":{"fontSize":"1.6rem"}}} -->
		<h2 class="wp-block-heading" style="font-size:1.6rem"><?php esc_html_e( 'Popular Categories', 'aegis' ); ?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group">
			<!-- wp:heading {"style":{"typography":{"fontSize":"1.6rem"}}} -->
			<h2 class="wp-block-heading" style="font-size:1.6rem"><?php esc_html_e( 'Useful Links', 'aegis' ); ?></h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"fontSize":"small"} -->
			<p class="has-small-font-size"><?php esc_html_e( 'Links I found useful and wanted to share.', 'aegis' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Untitled', 'aegis' ); ?>","url":"#","className":"is-style-arrow-link","style":{"typography":{"textDecoration":"underline"}}} /-->
		<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Untitled', 'aegis' ); ?>","url":"#","className":"is-style-arrow-link","style":{"typography":{"textDecoration":"underline"}}} /-->
		<!-- /wp:navigation -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group">
		<!-- wp:heading {"style":{"typography":{"fontSize":"1.6rem"}}} -->
		<h2 class="wp-block-heading" style="font-size:1.6rem"><?php esc_html_e( 'Search the site', 'aegis' ); ?></h2>
		<!-- /wp:heading -->

		<!-- wp:search {"label":"<?php echo esc_attr_x( 'Search', 'search form label', 'aegis' ); ?>","showLabel":false,"placeholder":"<?php echo esc_attr_x( 'Search...', 'search form placeholder', 'aegis' ); ?>","width":100,"widthUnit":"%","buttonText":"<?php echo esc_attr_x( 'Search', 'search form label', 'aegis' ); ?>"} /-->
	</div>
	<!-- /wp:group -->

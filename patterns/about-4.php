 ...
 * Slug: aegis/about-4
 * Categories: about
 * Description: Block Pattern Two Columns with Tagline, Heading, Paragraphs, Media, and Button
 * Keywords: about, vertical gradient, split layout, text, images, tagline, heading, description, visual storytelling, responsive
 * Viewport Width: 1200
    ...
    <div class="wp-block-group has-vertical-small-background-to-secondary-gradient-background has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-right:0;padding-bottom:var(--wp--preset--spacing--50);padding-left:0">
        ...
        <div class="wp-block-columns" style="margin-top:0;margin-bottom:0">
            ...
            <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:33.33%">
                ...
                <h2 class="wp-block-heading has-huge-font-size" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;text-transform:uppercase"><?php echo esc_html_x('[Heading]', 'Replace with a descriptive title', 'aegis'); ?></h2>
                <!-- /wp:heading -->
            ...
            <div class="wp-block-column" style="flex-basis:66.66%">
                ...
                <figure class="wp-block-image size-full is-style-aegis-effect-1-image"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/thumb_1920x1200_dark.webp" alt="<?php echo esc_attr__('Placeholder image: Brief description of the image and its context, non-text content for screen readers.', 'aegis'); ?>" style="aspect-ratio:16/9;object-fit:cover" /></figure>
                <!-- /wp:image -->

 ...
 * Description: Testimonians with animated heading, text, and media images block pattern
...
<div class="wp-block-group alignwide" style="margin-top:0;margin-bottom:0;padding-top:4rem;padding-bottom:4rem">
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column">
            ...
            <h5 class="wp-block-heading has-text-align-center has-small-font-size" style="font-style:normal;font-weight:600;line-height:1.6"><?php echo esc_html__( 'Voices & Verdicts', 'aegis' ); ?></h5>
            <!-- /wp:heading -->
            ...
            <div style="line-height:1.3;text-align:center" class="wp-block-aegis-companion-typing-text has-large-plus-font-size">
                <div class="aegis-typing-wrapper">
                    <span class="aegis-typing-prefix"><?php echo esc_html__( 'Perspectives from', 'aegis' ); ?></span>

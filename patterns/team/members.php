...
<!-- wp:group {"metadata":{"categories":["team"],"patternName":"members","name":"Team Members"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|xxs","bottom":"var:preset|spacing|xl"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull"
	style="padding-top:var(--wp--preset--spacing--xxs);padding-bottom:var(--wp--preset--spacing--xl)">
	...
	<div class="wp-block-group"
		...
		<p class="aligncenter has-text-align-center is-style-sub-heading aligncenter"><?php echo esc_html__( 'About', 'aegis' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<p class="aligncenter has-text-align-center has-18-font-size aligncenter"><?php echo esc_html__( 'The minds behind the machine. A multidisciplinary collective dedicated to engineering the future of digital expression.', 'aegis' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->

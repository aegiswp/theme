...
<!-- wp:group {"metadata":{"categories":["commerce"],"patternName":"recently-viewed","name":"Recently Viewed Products"},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|lg","bottom":"var:preset|spacing|lg"}}},"layout":{"type":"constrained"},"animation":{"event":"","iterationCount":"","duration":"","delay":""}} -->

...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","right":"var:preset|spacing|30","left":"var:preset|spacing|30"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"secondary","layout":{"type":"constrained"},"metadata":{"name":"<?php echo esc_html_x('02. eCommerce Pattern', 'Name of the pattern', 'aegis'); ?>"}} -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column has-background-background-color has-background">
            ...
            <div class="wp-block-group is-style-default" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
                ...
                <h3 class="wp-block-heading has-large-font-size"><?php echo esc_html_e('[Product Name]', 'aegis'); ?></h3>
                <!-- /wp:heading -->

                <!-- wp:paragraph -->
                <p><?php echo esc_html_x('[Description (50-150 characters): Enter a brief overview of a product.]', 'Call to action section text', 'aegis'); ?></p>
                <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column has-tertiary-background-color has-background">
            ...
            <div class="wp-block-group is-style-default" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
                ...
                <div class="wp-block-buttons">
                    ...
                    <div class="wp-block-button has-custom-font-size is-style-aegis-button-shadow-outline has-small-font-size" style="font-style:normal;font-weight:600"><a class="wp-block-button__link has-tertiary-background-color has-background wp-element-button"><?php echo esc_html_x( '[Call to Action]', 'Call to action button text', 'aegis' ); ?></a></div>
                    <!-- /wp:button -->
                </div>
                <!-- /wp:buttons -->
            </div>
        ...
        <div class="wp-block-column has-foreground-background-color has-background">
            ...
            <div class="wp-block-group is-style-default has-background-color has-text-color"
                ...
                <div class="wp-block-buttons">
                    ...
                    <div class="wp-block-button has-custom-font-size is-style-aegis-button-shadow-outline has-small-font-size" style="font-style:normal;font-weight:600"><a class="wp-block-button__link wp-element-button"><?php echo esc_html_x( '[Call to Action]', 'Call to action button text', 'aegis' ); ?></a>
                    </div>
                    <!-- /wp:button -->
                </div>
                <!-- /wp:buttons -->

 ...
 * Slug: aegis/faq-01
 * Categories: faq
 * Description: A two-column with headings and paragraphs on the left and heading, paragraph, icon, and call-to-action button on the right
...
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x('01. FAQ Pattern', 'Name of the pattern', 'aegis'); ?>"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","right":"var:preset|spacing|30","left":"var:preset|spacing|30"},"margin":{"top":"0","bottom":"0"}}},"gradient":"vertical-large-background-to-foreground","className":"about has-no-gradient-on-mobile","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull about has-no-gradient-on-mobile has-vertical-large-background-to-foreground-gradient-background has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--30)">
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column" style="padding-right:var(--wp--preset--spacing--50);padding-left:0;flex-basis:56.66%">
            ...
            <h4 class="wp-block-heading has-extra-large-font-size" style="font-style:normal;font-weight:500"><?php echo esc_html_x('[Heading (45 characters): Present a welcoming tone for users queries.]', 'Replace with a descriptive section title.', 'aegis'); ?></h4>
            <!-- /wp:heading -->
            ...
            <div class="wp-block-group alignfull faq" style="padding-top:var(--wp--preset--spacing--30);padding-right:0px;padding-bottom:0px;padding-left:0px">
                ...
                <div class="wp-block-group trigger is-style-default" style="border-bottom-color:var(--wp--preset--color--foreground);border-bottom-width:1px;padding-top:0;padding-right:0;padding-bottom:var(--wp--preset--spacing--30);padding-left:0">
                    ...
                    <h4 class="wp-block-heading has-medium-font-size" style="font-style:normal;font-weight:400"><?php echo wp_kses_post( _x( '<strong>#.</strong> [Question (57 characters): Frame a frequently asked question about a feature or service.]', 'Replace with a frequently asked question', 'aegis' ) ); ?></h4>
                    <!-- /wp:heading -->
                ...
                <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|30","right":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"var:preset|spacing|30"}}},"backgroundColor":"tertiary","className":"content","layout":{"type":"constrained"}} -->
                <div class="wp-block-group content has-tertiary-background-color has-background" style="padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
        ...
        <div class="wp-block-column is-vertically-aligned-center has-foreground-background-color has-background" style="flex-basis:43.33%">
            ...
            <div class="wp-block-group is-style-default has-background-color has-text-color" style="padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
                ...
                <div class="wp-block-group icon has-foreground-background-color has-background" style="border-radius:100px;padding-top:15px;padding-right:15px;padding-bottom:15px;padding-left:15px">
                    ...
                    <figure class="wp-block-image size-large is-resized has-icon"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/icons/questions.svg" alt="<?php echo esc_attr__('Decorative element', 'aegis'); ?>" style="width:40px;height:undefinedpx" /></figure>
                    <!-- /wp:image -->
                </div>
                <!-- /wp:group -->

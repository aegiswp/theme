...
<!-- wp:group {"metadata":{"categories":["faq"],"patternName":"accordion","name":"Accordion"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|lg","bottom":"var:preset|spacing|lg"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull"
    ...
    <details class="wp-block-details is-style-surface is-style-default"
        ...
        <!-- wp:paragraph {"placeholder":"Type / to add a hidden block","fontSize":"16"} -->
        <p class="has-16-font-size">The Customizer has been retired in favor of the Site Editor (Appearance → Editor).
            This gives you total control over headers, footers, and page templates visually, without relying on legacy
            options.</p>
        <!-- /wp:paragraph -->
    </details>
    <!-- /wp:details -->
    ...
    <details class="wp-block-details is-style-surface is-style-default"
        ...
        <p class="is-style-default has-16-font-size">Access the Header template part within the Site Editor. Select the
            existing placeholder and replace it with a Site Logo, Image, or Inline SVG block. We recommend utilizing raw
    ...
    <details class="wp-block-details is-style-surface is-style-default"
        ...
        <!-- wp:paragraph {"placeholder":"Type / to add a hidden block","className":"is-style-default","fontSize":"16"} -->
        <p class="is-style-default has-16-font-size">Menus are now managed via the Navigation Block. Click on the header
    ...
    <details class="wp-block-details is-style-surface is-style-default"
        ...
        <p class="is-style-default has-16-font-size">Open the Styles panel (the half-shaded circle icon) in the
            top-right of the Editor. Changes made here propagate instantly across the entire site architecture, updating
    ...
    <details class="wp-block-details is-style-surface is-style-default"
        ...
        <!-- wp:paragraph {"placeholder":"Type / to add a hidden block","className":"is-style-default","fontSize":"16"} -->
        <p class="is-style-default has-16-font-size">Motion parameters are integrated directly into the block's settings
            panel. Within the Animation control group, you can define kinetic properties including the triggering Event
            (such as "Enter"), the Effect style, Easing curve, and precise timing curves for Duration and Delay without
            writing any code.</p>
        <!-- /wp:paragraph -->
    </details>
    <!-- /wp:details -->

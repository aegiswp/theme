 ...
 * Slug: aegis/about-1
 * Categories: about
 * Description: Two-column block pattern with media on the left and tagline, headline, paragraph, and button on the right
 * Keywords: about, buttons, columns, heading, image, media
 * Viewport Width: 1400
...
<div class="wp-block-group has-diagonal-secondary-to-background-gradient-background has-background" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
    ...
    <div class="wp-block-media-text alignwide is-stacked-on-mobile">
        <figure class="wp-block-media-text__media"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/thumb_1920x1200_dark.webp" alt="<?php echo esc_attr__('Placeholder image: Brief description of the image and its context, non-text content for screen readers.', 'aegis'); ?>" class="wp-image-1410 size-full" /></figure>

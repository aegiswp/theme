...
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x( '05. Archive Pattern', 'Name of the pattern', 'aegis' ); ?>","categories":["<?php echo esc_html_x( 'archives', 'Category name', 'aegis' ); ?>"],"patternName":"aegis/archive-05"},"layout":{"type":"default"}} -->

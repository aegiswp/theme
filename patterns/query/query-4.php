<?php
/**
 * 04. Blog Block Pattern
 */
return array(
	'title'	  => __( '04. Blog Pattern', 'aegis' ),
	'description' => __( 'Blog Archive with left Sidebar', 'aegis' ),
	'categories' => array( 'aegis-query' ),
	'content' => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained"},"metadata":{"name":"' . esc_html__('04. Blog Pattern', 'aegis') . '"}} -->

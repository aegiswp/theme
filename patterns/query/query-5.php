<?php
/**
 * 05. Blog Block Pattern
 */
return array(
	'title'	  => __( '05. Blog Pattern', 'aegis' ),
	'description' => __('Blog Archive with left Sidebar', 'aegis' ),
	'categories' => array( 'aegis-query' ),
	'content' => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained"},"metadata":{"name":"' . esc_html__('05. Blog Pattern', 'aegis') . '"}} -->
				...
				<div class="wp-block-group alignfull" style="padding-right:0">
					...
					<div class="wp-block-group is-style-default" style="padding-right:0;padding-left:0">
						...
						<div class="wp-block-query">
							...
							<!-- wp:group {"style":{"spacing":{"padding":{"top":"20px","bottom":"0"}}}} -->
							<div class="wp-block-group" style="padding-top:20px;padding-bottom:0">

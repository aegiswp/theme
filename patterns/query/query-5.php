...
<div class="wp-block-group alignfull blog-sidebar" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--30)">
	...
	<div class="wp-block-group alignwide" style="padding-right:0;padding-left:0">
		...
		<div class="wp-block-columns alignwide">
			<!-- wp:column {"width":"33.33%","style":{"spacing":{"padding":{"top":"0","bottom":"0"}}},"className":"hide-on-mobile"} -->
			<div class="wp-block-column hide-on-mobile" style="padding-top:0;padding-bottom:0;flex-basis:33.33%">
				...
				<div class="wp-block-group is-style-aegis-border has-septenary-background-color has-background" style="padding-bottom:var(--wp--preset--spacing--40)">
					...
					<figure class="wp-block-image aligncenter size-full"><img src="' . esc_url(get_template_directory_uri()) . '/assets/images/thumb_1920x1200_dark.webp" alt="' . esc_attr__('Describe the main elements of the image and its context.', 'aegis') . '" /></figure>
					<!-- /wp:image -->
						...
						<div class="wp-block-query">
							...
							<div class="wp-block-group" style="padding-top:15px;padding-bottom:0">
								...
								<div class="wp-block-group has-negative-margin" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
									...
									<!-- wp:post-date {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"spacing":{"padding":{"top":"10px","right":"10px","bottom":"10px","left":"0px"},"margin":{"top":"0","right":"0","bottom":"0","left":"0"}}},"backgroundColor":"background","textColor":"foreground","className":"is-style-default","fontSize":"tiny"} /-->
								</div>
								<!-- /wp:group -->
								...
								<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--30);margin-bottom:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
									<!-- wp:post-title {"isLink":true,"style":{"spacing":{"margin":{"top":"var:preset|spacing|30","bottom":"0"}}},"fontSize":"var(-wp--custom--typography--font-size--huge, clamp(2.25rem, 4vw, 2.75rem))"} /-->

<?php
/**
 * Title: 02. Blog Archive Sidebar Pattern
 * Slug: aegis/blog-archive-sidebar-2
 * Categories: blog
...
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x('02. Blog Archive Sidebar Pattern', 'Name of the pattern', 'aegis'); ?>"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
                ...
                <div class="wp-block-group alignwide">
                    ...
                    <div class="wp-block-group has-border-color has-foreground-border-color has-secondary-background-color has-background" style="border-width:1px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
                        ...
                        <p class="has-text-align-center has-tiny-font-size"
                            style="margin-top:5px;margin-right:0;margin-bottom:0;margin-left:0;text-transform:uppercase"><?php echo wp_kses_post( _x( '[Position]', 'Replace with the author\'s position', 'aegis' ) ); ?></p>
                        <!-- /wp:paragraph -->

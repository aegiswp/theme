...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--xxl);padding-bottom:var(--wp--preset--spacing--lg)">
		...
		<div class="wp-block-group"><!-- wp:paragraph {"align":"center","className":"is-style-sub-heading"} -->
			...
			<h1 class="wp-block-heading has-text-align-center has-52-font-size"><?php echo esc_html__( 'We\'d Love to Hear From You', 'aegis' ); ?></h1>
			<!-- /wp:heading -->
			...
			<p class="aligncenter has-text-align-center has-neutral-600-color has-text-color has-18-font-size aligncenter">
				<?php echo esc_html__( 'Have a question, project idea, or just want to say hello? Drop us a message and we\'ll get back to you within 24 hours.', 'aegis' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>
		...
		<div class="wp-block-columns alignwide"><!-- wp:column {"width":"60%"} -->
			<div class="wp-block-column" style="flex-basis:60%">
				...
				<div class="wp-block-group is-style-surface" style="padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--lg)">
					...
					<h3 class="wp-block-heading has-28-font-size"><?php echo esc_html__( 'Send Us a Message', 'aegis' ); ?></h3>
					<!-- /wp:heading -->
					...
					<form action="#" method="POST" style="display:flex;flex-direction:column;gap:1.5rem">
						<div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
							<div>
								<label for="name"
									style="display:block;margin-bottom:0.5rem;font-weight:500"><?php echo esc_html__( 'Name', 'aegis' ); ?></label>
								<input type="text" id="name" name="name" required
									style="width:100%;padding:0.75rem;border:1px solid #e5e7eb;border-radius:6px">
							</div>
							<div>
								<label for="email"
									style="display:block;margin-bottom:0.5rem;font-weight:500"><?php echo esc_html__( 'Email', 'aegis' ); ?></label>
						...
						<div>
							<label for="subject"
								style="display:block;margin-bottom:0.5rem;font-weight:500"><?php echo esc_html__( 'Subject', 'aegis' ); ?></label>
							<input type="text" id="subject" name="subject" required
								style="width:100%;padding:0.75rem;border:1px solid #e5e7eb;border-radius:6px">
						</div>
						<div>
							<label for="message"
								style="display:block;margin-bottom:0.5rem;font-weight:500"><?php echo esc_html__( 'Message', 'aegis' ); ?></label>
						...
						<div class="wp-block-buttons">
							<div class="wp-block-button has-custom-width wp-block-button__width-100">
								<button type="submit" class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Send Message', 'aegis' ); ?></button>
							</div>
						</div>
					</form>
					<!-- /wp:html -->
			...
			<div class="wp-block-column" style="flex-basis:40%">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group"><!-- wp:heading {"level":4,"fontSize":"20"} -->
						<h4 class="wp-block-heading has-20-font-size"><?php echo esc_html__( 'Office Location', 'aegis' ); ?></h4>
						<!-- /wp:heading -->

						<!-- wp:paragraph {"textColor":"neutral-600"} -->
						<p class="has-neutral-600-color has-text-color"><?php echo wp_kses_post( __( 'Cra. 5 #8-36, <br>Distrito Capital, Bogotá<br>Colombia', 'aegis' ) ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
					...
					<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|xs"}},"layout":{"type":"flex","orientation":"vertical"}} -->
					<div class="wp-block-group"><!-- wp:heading {"level":4,"fontSize":"20"} -->
						<h4 class="wp-block-heading has-20-font-size"><?php echo esc_html__( 'Contact Details', 'aegis' ); ?></h4>
						<!-- /wp:heading -->

						<!-- wp:paragraph {"textColor":"neutral-600"} -->
						<p class="has-neutral-600-color has-text-color"><strong><?php echo esc_html__( 'Email:', 'aegis' ); ?></strong> <a
								href="mailto:info@youremail.com">info@youremail.com</a><br><strong><?php echo esc_html__( 'Phone:', 'aegis' ); ?></strong> <a
								href="tel:576010192834" data-type="tel" data-id="tel:576010192834">+57 (601)
								019-2834</a><br><strong><?php echo esc_html__( 'Fax:', 'aegis' ); ?></strong> <a href="tel:576010192834" data-type="tel"
					...
					<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|xs"}},"layout":{"type":"flex","orientation":"vertical"}} -->
					<div class="wp-block-group"><!-- wp:heading {"level":4,"fontSize":"20"} -->
						<h4 class="wp-block-heading has-20-font-size"><?php echo esc_html__( 'Business Hours', 'aegis' ); ?></h4>
						<!-- /wp:heading -->

						<!-- wp:paragraph {"textColor":"neutral-600"} -->
						<p class="has-neutral-600-color has-text-color"><strong><?php echo esc_html__( 'Monday - Friday:', 'aegis' ); ?></strong> <?php echo esc_html__( '9:00 AM - 6:00 PM', 'aegis' ); ?><br><strong><?php echo esc_html__( 'Saturday:', 'aegis' ); ?></strong> <?php echo esc_html__( '10:00 AM - 4:00 PM', 'aegis' ); ?><br><strong><?php echo esc_html__( 'Sunday:', 'aegis' ); ?></strong> <?php echo esc_html__( 'Closed', 'aegis' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
	...
	<div class="wp-block-group alignfull has-neutral-50-background-color has-background" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl)">
		...
		<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","fontSize":"32"} -->
			<h2 class="wp-block-heading has-text-align-center has-32-font-size"><?php echo esc_html__( 'Frequently Asked Questions', 'aegis' ); ?></h2>
			<!-- /wp:heading -->
			...
			<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--lg)">
				...
				<details class="wp-block-details" style="border-bottom-color:var(--wp--preset--color--neutral-200);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--sm);padding-bottom:var(--wp--preset--spacing--sm)">
					<summary><strong><?php echo esc_html__( 'What is your typical response time?', 'aegis' ); ?></strong></summary>
					<!-- wp:paragraph {"textColor":"neutral-600","fontSize":"15"} -->
					<p class="has-neutral-600-color has-text-color has-15-font-size"><?php echo esc_html__( 'We aim to respond to all inquiries within 24 business hours. For urgent matters, please call our office directly.', 'aegis' ); ?></p>
					<!-- /wp:paragraph -->
				</details>
				<!-- /wp:details -->
				...
				<!-- wp:details {"style":{"spacing":{"padding":{"top":"var:preset|spacing|sm","bottom":"var:preset|spacing|sm"}},"border":{"bottom":{"color":"var:preset|color|neutral-200","width":"1px"}}},"expandIcon":"chevron"} -->
				<details class="wp-block-details" style="border-bottom-color:var(--wp--preset--color--neutral-200);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--sm);padding-bottom:var(--wp--preset--spacing--sm)">
					<summary><strong><?php echo esc_html__( 'Do you offer free consultations?', 'aegis' ); ?></strong></summary>
					<!-- wp:paragraph {"textColor":"neutral-600","fontSize":"15"} -->
					<p class="has-neutral-600-color has-text-color has-15-font-size"><?php echo esc_html__( 'Yes! We offer a complimentary 30-minute discovery call to discuss your project needs and determine if we\'re a good fit.', 'aegis' ); ?></p>
					<!-- /wp:paragraph -->
				</details>
				<!-- /wp:details -->
				...
				<!-- wp:details {"style":{"spacing":{"padding":{"top":"var:preset|spacing|sm","bottom":"var:preset|spacing|sm"}},"border":{"bottom":{"color":"var:preset|color|neutral-200","width":"1px"}}},"expandIcon":"chevron"} -->
				<details class="wp-block-details" style="border-bottom-color:var(--wp--preset--color--neutral-200);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--sm);padding-bottom:var(--wp--preset--spacing--sm)">
					<summary><strong><?php echo esc_html__( 'What industries do you work with?', 'aegis' ); ?></strong></summary>
					<!-- wp:paragraph {"textColor":"neutral-600","fontSize":"15"} -->
					<p class="has-neutral-600-color has-text-color has-15-font-size"><?php echo esc_html__( 'We work with clients across various industries including technology, healthcare, finance, e-commerce, education, and non-profit organizations.', 'aegis' ); ?></p>
					<!-- /wp:paragraph -->
				</details>
				<!-- /wp:details -->
			</div>

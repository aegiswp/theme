 ...
 * Keywords: about, profiles, visual array, team, thematic elements, constrained layout, imagery, textual content
 * Viewport Width: 1400
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained"},"metadata":{"name":"<?php echo esc_html_x('08. About Pattern', 'Name of the pattern', 'aegis'); ?>"}} -->

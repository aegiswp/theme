                ...
                <div class="wp-block-group alignfull" style="padding-right:0">
                    ...
                    <div class="wp-block-group is-style-default" style="padding-right:0;padding-left:0">
                        ...
                        <div class="wp-block-query">
                            ...
                            <!-- wp:group {"style":{"spacing":{"padding":{"bottom":"0","top":"14px"}}},"layout":{"type":"default"}} -->
                            <div class="wp-block-group" style="padding-top:14px;padding-bottom:0">
                                ...
                                <div class="wp-block-group has-negative-margin" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
                                    <!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"10px","bottom":"10px","left":"10px","right":"5px"}}},"backgroundColor":"secondary","fontSize":"tiny"} -->
                                    <p class="has-secondary-background-color has-background has-tiny-font-size"
                                        style="padding-top:10px;padding-right:5px;padding-bottom:10px;padding-left:10px"><?php echo esc_html_e('Published:', 'aegis'); ?></p>
                                    <!-- /wp:paragraph -->

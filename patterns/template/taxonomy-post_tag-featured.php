...
/**
 * Title: Tag Featured
 * Slug: taxonomy-post_tag-featured
 * Categories: template
 * Template Types: taxonomy-post_tag-featured
 * Inserter: false
 */
?>
...
<main id="main" class="wp-block-group alignfull site-main">
	...
	<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--xs);padding-bottom:var(--wp--preset--spacing--sm)">
		<!-- wp:query {"queryId":18,"query":{"perPage":6,"pages":"","offset":"","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true,"parents":[],"taxQuery":null,"format":[]},"align":"wide","layout":{"inherit":false},"style":{"spacing":{"blockGap":"1.5em"}}} -->
		<div class="wp-block-query alignwide">
			...
			<!-- wp:post-excerpt {"excerptLength":28,"hideReadMore":true,"fontSize":"14"} /-->
			<!-- /wp:post-template -->
			...
			<!-- wp:query-no-results -->
			<!-- wp:paragraph -->
			<p><?php echo esc_html__( 'No featured posts.', 'aegis' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- /wp:query-no-results -->
		</div>
		<!-- /wp:query -->

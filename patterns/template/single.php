...
<!-- wp:group {"tagName":"main","anchor":"main","align":"full","className":"site-main","layout":{"type":"constrained"},"metadata":{"name":"Main"}} -->
<main id="main" class="wp-block-group alignfull site-main">
	<!-- wp:post-terms {"term":"category","style":{"spacing":{"padding":{"top":"var:preset|spacing|lg","bottom":"var:preset|spacing|xxs"}},"typography":{"textDecoration":"none"}},"className":"is-style-sub-heading","align":"center"} /-->
	...
	<div class="wp-block-group"
		style="padding-top:var(--wp--preset--spacing--xxs);padding-bottom:var(--wp--preset--spacing--xs);text-decoration:none">
		...
		<div class="wp-block-comments wp-block-comments-query-loop" style="text-decoration:none">
			...
			<div class="wp-block-columns" style="margin-bottom:var(--wp--preset--spacing--md)">
				...
				<div class="wp-block-column">
					...
					<!-- wp:comment-edit-link {"fontSize":"14"} /-->
				</div>
				<!-- /wp:column -->
			</div>
			<!-- /wp:columns -->

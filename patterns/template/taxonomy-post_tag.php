...
/**
 * Title: Tag Archive
 * Slug: taxonomy-post_tag
 * Categories: template
 * Template Types: taxonomy-post_tag
 * Inserter: false
 */
?>
...
<main id="main" class="wp-block-group alignfull site-main">
	...
	<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--xs);padding-bottom:var(--wp--preset--spacing--sm)">
		<!-- wp:query {"queryId":12,"query":{"perPage":10,"pages":"","offset":"","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true,"parents":[],"taxQuery":null,"format":[]},"align":"wide","layout":{"inherit":false},"style":{"spacing":{"blockGap":"1.5em"}}} -->
		<div class="wp-block-query alignwide">
			<!-- wp:post-template {"layout":{"type":"grid","columnCount":2}} -->
			<!-- wp:post-featured-image {"isLink":true,"style":{"aspectRatio":{"all":"4/3"},"objectFit":{"all":"cover"},"objectPosition":{"all":"center"},"height":{"all":"100%"},"width":{"all":"100%"}}} /-->
			<!-- wp:post-date {"fontSize":"12"} /-->
			<!-- wp:post-title {"level":3,"isLink":true,"fontSize":"22"} /-->
			<!-- wp:post-excerpt {"excerptLength":18,"hideReadMore":true,"fontSize":"14"} /-->
			<!-- /wp:post-template -->
			...
			<!-- wp:query-no-results -->
			<!-- wp:paragraph -->
			<p><?php echo esc_html__( 'No posts with this tag.', 'aegis' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- /wp:query-no-results -->
		</div>
		<!-- /wp:query -->

	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column" style="flex-basis:25%">
			...
			<div class="wp-block-group">
				...
				<h4 class="wp-block-heading has-16-font-size"><?php echo esc_html__( 'Refine Results', 'aegis' ); ?></h4>
				<!-- /wp:heading -->
		...
		<div class="wp-block-column" style="flex-basis:75%">
			<!-- wp:woocommerce/product-collection {"queryId":4,"query":{"perPage":12,"pages":0,"offset":0,"postType":"product","order":"desc","orderBy":"relevance","search":"","exclude":[],"inherit":true,"taxQuery":{},"isProductCollectionBlock":true,"featured":false,"woocommerceOnSale":false,"woocommerceStockStatus":["instock","outofstock","onbackorder"],"woocommerceAttributes":[],"woocommerceHandPickedProducts":[],"filterable":true,"relatedBy":{"categories":true,"tags":true}},"tagName":"div","displayLayout":{"type":"flex","columns":3,"shrinkColumns":true},"dimensions":{"widthType":"fill"},"queryContextIncludes":["collection"]} -->
			<div class="wp-block-woocommerce-product-collection">
				...
				<div class="wp-block-group">
					...
					<p class="has-18-font-size"><strong><?php echo esc_html__( 'No products found', 'aegis' ); ?></strong></p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"textColor":"neutral-600"} -->
					<p class="has-neutral-600-color has-text-color"><?php echo esc_html__( 'Sorry, we couldn\'t find any products matching your search. Try a different keyword or browse our store.', 'aegis' ); ?></p>
					<!-- /wp:paragraph -->

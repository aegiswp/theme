...
<!-- wp:group {"metadata":{"name":"<?php echo esc_html_x( '02. Archive Pattern', 'Name of the pattern', 'aegis' ); ?>","categories":["<?php echo esc_html_x( 'archives', 'Name of the category', 'aegis' ); ?>"],"patternName":"aegis/archive-02"},"style":{"spacing":{"padding":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:0;padding-bottom:0">
    ...
    <div class="wp-block-query alignwide">
        ...
        <!-- wp:query-pagination-previous {"label":"<?php echo esc_html_x( 'Previous Posts', 'Pagination previous posts button text', 'aegis' ); ?>"} /-->

        <!-- wp:query-pagination-numbers /-->

        <!-- wp:query-pagination-next {"label":"<?php echo esc_html_x( 'Next Posts', 'Pagination next posts button text', 'aegis' ); ?>"} /-->
        <!-- /wp:query-pagination -->
    </div>
    <!-- /wp:query -->
</div>

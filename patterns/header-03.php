...
<!-- wp:group {"metadata":{"categories":["header"],"patternName":"header-03","name":"<?php echo esc_html_x('03. Header Pattern (Sticky)', 'Name of the pattern', 'aegis'); ?>"},"align":"full","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"className":"header","layout":{"inherit":false}} -->

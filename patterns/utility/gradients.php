...
$gradients       = $global_settings['color']['gradients']['theme'] ?? array();
$defaults        = $global_settings['color']['gradients']['default'] ?? array();
	...
	<div class="wp-block-group has-14-font-size">
		...
		<div class="wp-block-group">
			...
			foreach ( $gradients as $gradient ) :
				...
				echo str_replace( array( '{slug}', '{value}', '{on_click_value}' ), array( $slug, $value, $on_click_value ), $item ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Generated block markup from theme.json gradient presets.
			endforeach;
			?>

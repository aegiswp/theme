    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column" style="flex-basis:33.33%">
            ...
            <div class="wp-block-cover has-custom-content-position is-position-bottom-center" style="min-height:100vh">
                ...
                <img class="wp-block-cover__image-background" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/thumb_1200x1920_dark.webp" alt="<?php echo esc_attr__('Placeholder image: Brief description of the image and its context, non-text content for screen readers.', 'aegis'); ?>" style="object-position:26% 37%" data-object-fit="cover" data-object-position="26% 37%" />
                <div class="wp-block-cover__inner-container">
                    ...
                    <div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--30)">
                        ...
                        <h3 class="wp-block-heading has-gigantic-font-size" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px;padding-top:0;padding-bottom:0;text-transform:none"><?php echo esc_html_x('[Heading]', 'Replace with a descriptive title', 'aegis'); ?></h3>
                        <!-- /wp:heading -->

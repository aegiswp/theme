...
<div class="wp-block-button"><a class="wp-block-button__link has-primary-900-color has-white-background-color has-text-color has-background has-16-font-size has-custom-font-size wp-element-button" href="#"><?php echo esc_html__( 'Shop the Sale', 'aegis' ); ?></a></div>
<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>

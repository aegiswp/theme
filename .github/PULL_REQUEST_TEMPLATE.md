...
<!-- Please describe any accessibility implications -->
...
### Code Quality
- [ ] My code follows the project's coding standards (WordPress & PSR-12)
- [ ] I have run `npm run lint:js` and `npm run lint:css`
- [ ] I have run `composer lint` and fixed any PHPCS issues
- [ ] My changes generate no new warnings or errors

### Testing
- [ ] I have tested my changes locally in multiple browsers
- [ ] I have tested on both mobile and desktop (if applicable)
- [ ] I have tested with and without JavaScript enabled (if applicable)
- [ ] I have tested with different screen sizes and devices

### Documentation
- [ ] My changes are well-documented with inline comments
...
- [ ] CI/CD workflows (ci.yml, accessibility.yml, wordpress-compat.yml, lighthouse-ci.yml, spelling.yml) are passing
- [ ] If `theme.json` changed, theme-json-validation.yml is passing
...
- ✓ **Theme.json Validation**: Runs only when `theme.json` changes
- ✓ **WordPress Compatibility Matrix**: Tests against WP 7.0/latest + PHP 8.1/8.2/8.3 (6 jobs)
- ✓ **Lighthouse CI**: Performance and accessibility metrics
- ✓ **Spelling Check**: Catches typos

**Required checks must pass before this PR can be merged.** Path-filtered workflows (such as theme.json validation) are skipped when their files do not change.

## Additional Notes

<!-- Any additional context, questions, or concerns for reviewers -->

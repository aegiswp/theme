...
/**
 * Centralized registration and conditional enqueueing of theme assets.
 */
class AssetManager {
	...
	public static function init(): void {
		add_action( 'init', array( __CLASS__, 'register_core_assets' ) );
		add_action( 'wp_enqueue_scripts', array( __CLASS__, 'conditionally_enqueue_assets' ), 10 );
		add_action( 'admin_enqueue_scripts', array( __CLASS__, 'conditionally_enqueue_admin_assets' ), 10 );
	}

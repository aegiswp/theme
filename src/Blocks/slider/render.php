...
$data_attrs = sprintf(
	'data-type="%s" data-per-page="%s" data-per-move="%s" data-autoplay="%s" data-pause-on-hover="%s" data-loop="%s" data-drag="%s" data-show-arrows="%s" data-show-dots="%s" data-speed="%s" data-interval="%s" data-direction="%s" data-height="%s" data-breakpoints="%s" data-gap="%s"',
	esc_attr( $type ),

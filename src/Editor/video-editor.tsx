...
const VimeoIcon = () => (
	...
	>
		<g clipPath="url(#clip0_vimeo)">
			<path
				d="M22.875 10.063C20.433 15.28 14.538 22.382 10.812 22.382C7.14 22.382 6.609 14.551 4.604 9.339C3.617 6.774 2.98 7.363 1.13 8.658L0.0019989 7.203C2.7 4.831 5.4 2.076 7.059 1.923C8.927 1.744 10.077 3.021 10.507 5.755C11.075 9.348 11.869 14.925 13.255 14.925C14.335 14.925 16.996 10.501 17.133 8.919C17.376 6.603 15.43 6.533 13.741 7.256C16.414 -1.498 27.534 0.113998 22.875 10.063Z"
				stroke="#007CBA"
				strokeWidth="2"
				strokeLinecap="round"
				strokeLinejoin="round"
...
const BunnyIcon = () => (
	...
	>
		<path
			d="M15.734 5.13223L23.1293 9.14822L16.2959 0C15.7536 0.727851 15.4155 1.58737 15.3167 2.48967C15.2179 3.39196 15.362 4.30427 15.734 5.13223Z"
			fill="#007CBA"
		/>
		<path
			d="M12.3923 20.0273C12.8394 20.0273 13.2682 20.2049 13.5843 20.5211C13.9004 20.8372 14.078 21.266 14.078 21.7131C14.078 22.1601 13.9004 22.5889 13.5843 22.905C13.2682 23.2212 12.8394 23.3988 12.3923 23.3988C11.9452 23.3988 11.5165 23.2212 11.2003 22.905C10.8842 22.5889 10.7066 22.1601 10.7066 21.7131C10.7066 21.266 10.8842 20.8372 11.2003 20.5211C11.5165 20.2049 11.9452 20.0273 12.3923 20.0273Z"
			fill="#007CBA"
		/>
		<path
			d="M7.24523 1.34112L27.9541 12.5798C28.1234 12.6622 28.2662 12.7905 28.366 12.9502C28.4658 13.1098 28.5188 13.2943 28.5188 13.4826C28.5188 13.6709 28.4658 13.8554 28.366 14.015C28.2662 14.1747 28.1234 14.303 27.9541 14.3854C26.3879 15.3278 24.6726 15.9967 22.8818 16.3633L18.5736 25.2046C18.5736 25.2046 17.2102 28.3065 13.4564 27.1152C15.0298 25.5418 16.9328 24.1181 16.9328 21.6983C16.9328 19.1865 14.8966 17.1505 12.385 17.1505C9.87326 17.1505 7.83728 19.1865 7.83728 21.6983C7.83728 24.86 10.9539 26.1935 12.6848 28.3889C13.0629 28.9242 13.2448 29.5735 13.1997 30.2273C13.1547 30.8811 12.8855 31.4993 12.4375 31.9777C10.287 29.85 6.12878 26.261 4.42049 23.9084C3.48655 22.7223 2.97267 21.2597 2.95944 19.7501C3.04152 18.1438 3.61631 16.6017 4.60566 15.3336C5.595 14.0655 6.95089 13.1328 8.48898 12.6624C9.43233 12.3876 10.4142 12.2686 11.3959 12.3102C12.7648 12.4139 14.0944 12.8153 15.292 13.4865C17.1278 14.5654 18.0193 14.2807 19.2854 13.2169C20.0347 12.6025 20.8512 10.6019 19.5851 10.1374C19.1712 10.0024 18.7481 9.89728 18.319 9.8229C15.9664 9.36574 11.8531 8.93113 10.3395 8.06951C7.93444 6.74335 6.31616 4.0084 7.24523 1.34112Z"
			fill="#007CBA"
		/>
		<path
			d="M16.8955 21.7204C17.8545 16.6781 12.737 11.868 8.81099 12.5871L9.07341 12.5272C8.86348 12.5721 8.66135 12.6248 8.46639 12.6847C6.92835 13.1551 5.5725 14.0878 4.5832 15.356C3.5939 16.6241 3.01914 18.1662 2.93707 19.7724C2.96099 21.2865 3.48823 22.7495 4.43564 23.9307C6.14371 26.2833 10.302 29.8723 12.4525 32C12.9004 31.5217 13.1696 30.9034 13.2147 30.2496C13.2597 29.5958 13.0778 28.9465 12.6997 28.4112C10.9313 26.2235 7.81448 24.8823 7.81448 21.728C7.81448 19.2162 9.85089 17.1802 12.3625 17.1802C14.8742 17.1802 16.9102 19.2162 16.9102 21.728L16.8955 21.7204Z"
			fill="#007CBA"
		/>
		<path
			d="M7.24522 1.34112L22.9791 9.91247L23.4287 10.1597C23.8035 10.4518 24.178 11.0363 23.6911 12.1152C22.9418 13.7261 19.9449 15.2846 16.4908 14.0631C17.5697 14.3778 18.3038 14.0182 19.2481 13.2241C19.9972 12.6097 20.8139 10.6093 19.5476 10.1445C19.1336 10.0095 18.7105 9.90444 18.2815 9.83006C15.9289 9.3729 11.8155 8.93851 10.302 8.07688C7.93443 6.74313 6.31593 4.0084 7.24522 1.34112Z"
			fill="#007CBA"
		/>
		<path
			d="M7.24515 1.34112C8.87102 7.33497 18.7685 7.82965 23.7283 10.3321L7.24515 1.34112Z"
			fill="#007CBA"
		/>
		<path
			d="M12.6623 28.4112C10.9316 26.2234 7.81458 24.8823 7.81458 21.7279C7.82347 19.4402 9.53045 17.5152 11.8006 17.2324C8.18499 17.2448 5.25703 20.1728 5.24467 23.7884C5.24402 24.2313 5.28912 24.6733 5.37956 25.107C6.81068 26.7253 8.87854 28.6359 10.6243 30.2542C11.3062 30.8911 11.9355 31.4903 12.4526 32C12.8827 31.5015 13.1448 30.8802 13.2016 30.2243C13.2426 29.5751 13.0514 28.9325 12.6623 28.4112Z"
			fill="#007CBA"
		/>
		<path
			d="M16.873 22.26C16.8966 22.081 16.9092 21.9008 16.9105 21.7204C17.8545 16.6782 12.737 11.868 8.81105 12.5871C9.64941 12.3846 10.5118 12.2989 11.3736 12.3325C16.5208 12.5422 17.9593 18.0416 16.873 22.26Z"
			fill="#007CBA"
		/>
		<path
			d="M1.69332 11.1189C2.14306 11.1209 2.57371 11.3009 2.89105 11.6196C3.2084 11.9383 3.38659 12.3697 3.38664 12.8194V14.5127H1.69332C1.47095 14.5127 1.25076 14.4689 1.04531 14.3838C0.839872 14.2987 0.653201 14.174 0.495962 14.0168C0.338723 13.8595 0.213994 13.6729 0.128896 13.4674C0.043799 13.262 0 13.0418 0 12.8194C-4.22733e-08 12.3696 0.178163 11.9382 0.495512 11.6194C0.812861 11.3007 1.24355 11.1209 1.69332 11.1189Z"
			fill="#007CBA"
		/>
	</svg>
);
...
const VIDEO_TYPES = [
	...
	{
		type: 'youtube',
		label: __( 'YouTube', 'aegis' ),
		icon: YouTubeIcon,
		premium: false,
	},
	{
		type: 'vimeo',
		label: __( 'Vimeo', 'aegis' ),
		icon: VimeoIcon,
		premium: false,
	},
	{
		type: 'audio',
		label: __( 'Audio', 'aegis' ),
		icon: AudioIcon,
		premium: false,
	},
	{
		type: 'bunny',
		label: __( 'Bunny.net', 'aegis' ),
		icon: BunnyIcon,
		premium: true,
	},
];
...
const withVideoTypeSelector = createHigherOrderComponent( ( BlockEdit ) => {
	return ( props: any ) => {
				...
				<div { ...blockProps }>
					<div className="aegis-video-type-selector">
						<div className="aegis-video-type-selector__header">
							<svg
								className="aegis-video-type-selector__logo"
								viewBox="0 0 24 24"
								fill="currentColor"
								xmlns="http://www.w3.org/2000/svg"
							>
							...
							<span className="aegis-video-type-selector__title">
								{ __( 'Video', 'aegis' ) }
							</span>
						</div>
						...
						<div className="aegis-video-type-selector__options">
							{ VIDEO_TYPES.map(
								( { type, label, icon: Icon, premium } ) => {
									const hasAccess = ! premium || isPro;
									return (
										<button
											key={ type }
											type="button"
											className={ `aegis-video-type-option${
												premium && ! isPro
													? ' aegis-video-type-option--pro'
													: ''
											}` }
											onClick={ () => {
												if ( hasAccess ) {
										...
										>
											{ premium && ! isPro && (
												<span className="aegis-video-type-option__pro-badge">
													Pro
												</span>
											) }
		...
		if (
			aegisVideoType === 'bunny' &&
			( ! aegisBunnyLibraryId || ! aegisBunnyVideoId )
		) {
			return (
				<div { ...blockProps }>
					<Placeholder
						...
						instructions={ __(
							'Enter your Bunny.net Stream details.',
							'aegis'
						) }
...
function addVideoTypeClass( props: any, blockType: any, attributes: any ) {
	...
	return {
		...
		className: `${
			props.className || ''
		} aegis-video-type-${ aegisVideoType }`.trim(),
	};
}
